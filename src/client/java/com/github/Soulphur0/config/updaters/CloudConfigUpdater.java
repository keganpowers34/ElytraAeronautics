...
public class CloudConfigUpdater {
    ...
    // ; settingAttributes holds everything after the settingCategory value, already stripped by the caller.

    public static void updateGeneralConfig(Minecraft client, String[] settingAttributes){
        LocalPlayer player = client.player;

        String settingName = settingAttributes[0];
        String value = settingAttributes[1];
            ...
            switch (settingName){
                case "useEanCloudRendering" -> {
                    ...
                    if (value.equals("-help")){
                        player.sendSystemMessage(EanCommandHelp.useEanCloudRendering());
                        return;
                    }

                    // _ Validate value
                    if(!(value.equalsIgnoreCase("true") || value.equalsIgnoreCase("false"))){
                        player.sendSystemMessage(Component.translatable("command.error.value.boolean").withStyle(ChatFormatting.RED));
                        return;
                    }
                    ...
                    player.sendSystemMessage(Component.nullToEmpty(notification));
                }
                case "setCloudLayerAmount" -> {
                    // _ Print help if the value was -help.
                    if (value.equals("-help")){
                        player.sendSystemMessage(EanCommandHelp.setCloudLayerAmount());
                        return;
                    }
                    ...
                    try{
                        ...
                        player.sendSystemMessage(Component.translatable("command.error.value").withStyle(ChatFormatting.RED));
                        return;
                    }
                ...
                case "loadPreset" -> {
                    // _ Print help if the value was -help.
                    if (value.equals("-help")){
                        player.sendSystemMessage(EanCommandHelp.loadPreset());
                        return;
                    }
    ...
    public static void updateCloudLayerConfig(Minecraft client, String[] settingAttributes){
        LocalPlayer player = client.player;

        String settingName = settingAttributes[0];
        String layerNumber = settingAttributes[1];
        String value = settingAttributes[2];
        ...
        if (player != null){
            switch (settingName){
                case "altitude"->{
                    // _ Print help if the value was -help.
                    if (value.equals("-help")){
                        player.sendSystemMessage(EanCommandHelp.altitude());
                        return;
                    }
                    ...
                    try {
                        ...
                        player.sendSystemMessage(Component.translatable("command.error.layerNumber").withStyle(ChatFormatting.RED));
                        return;
                    }
                ...
                case "cloudType"->{
                    // _ Print help if the value was -help.
                    if (value.equals("-help")){
                        player.sendSystemMessage(EanCommandHelp.cloudType());
                        return;
                    }
                ...
                case "verticalRenderDistance"->{
                    // _ Print help if the value was -help.
                    if (value.equals("-help")){
                        player.sendSystemMessage(EanCommandHelp.verticalRenderDistance());
                        return;
                    }
                ...
                case "horizontalRenderDistance"->{
                    // _ Print help if the value was -help.
                    if (value.equals("-help")){
                        player.sendSystemMessage(EanCommandHelp.horizontalRenderDistance());
                        return;
                    }
                ...
                case "lodRenderDistance"->{
                    // _ Print help if the value was -help.
                    if (value.equals("-help")){
                        player.sendSystemMessage(EanCommandHelp.lodRenderDistance());
                        return;
                    }
                ...
                case "thickness"->{
                    // _ Print help if the value was -help.
                    if (value.equals("-help")){
                        player.sendSystemMessage(EanCommandHelp.thickness());
                        return;
                    }
                ...
                case "color"->{
                    // _ Print help if the value was -help.
                    if (value.equals("-help")){
                        player.sendSystemMessage(EanCommandHelp.color());
                        return;
                    }
                ...
                case "opacity"->{
                    // _ Print help if the value was -help.
                    if (value.equals("-help")){
                        player.sendSystemMessage(EanCommandHelp.opacity());
                        return;
                    }
                ...
                case "shading"->{
                    // _ Print help if the value was -help.
                    if (value.equals("-help")){
                        player.sendSystemMessage(EanCommandHelp.shading());
                        return;
                    }
                ...
                case "speed"->{
                    // _ Print help if the value was -help.
                    if (value.equals("-help")){
                        player.sendSystemMessage(EanCommandHelp.speed());
                        return;
                    }
                ...
                case "skyEffects"->{
                    // _ Print help if the value was -help.
                    if (value.equals("-help")){
                        player.sendSystemMessage(EanCommandHelp.skyEffects());
                        return;
                    }
